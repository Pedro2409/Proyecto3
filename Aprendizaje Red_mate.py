...
y_real = sample_test["punt_matematicas"].values

df2 = sample_test.drop(columns=['punt_matematicas'])
...
estimated_modelh = esth.estimate(
    scoring_method=scoring_method, max_indegree=4, max_iter=int(1e8)
)
...
estimated_modelBicScore = esth.estimate(
    scoring_method=scoring_method, max_indegree=4, max_iter=int(1e5)
)
